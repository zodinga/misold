...
class PagesController extends Controller{
	...
	public function getDashboard()
	{
		...
		return view('sms.home.dashboard')
	...
	public function getStudents($id)
	{
		...
		if($id==1)
			...
			$students->whereNotIn('course_id',[3,4,5,6])
						->where('status_id',1);
		$students=$students->orderBy('course_id')->orderBy('batch','desc')->orderBy('doj','desc')->paginate(8);

		return view('sms.students.index')->withStudents($students)->withCourses($courses)->withTitle("Filtered");
	}
}