...
class SubjectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sms.subjects.index')->withSubjects($subjects)
                                    ->withCourses($courses);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sms.subjects.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('sms.subjects.show')->withSubject($subject);
    }
    ...
    public function edit($id)
    {
        $subject=Subject::find($id);
        $courses=Course::pluck('name','id');
        return view('sms.subjects.edit')->withSubject($subject)->withCourses($courses);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('sms.subjects.index',$subject->id);
