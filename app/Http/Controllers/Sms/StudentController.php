...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        //return
        return view('sms.students.index')->withCourses($courses)->withStudents($students);
    }
    ...
    public function create()
    {
        ...
        return view('sms.students.create')
    ...
    public function show($id)
    {
        ...
        return view('sms.students.show')->withStudent($student);
    }
    ...
    public function edit($id)
    {
        ...
        return view('sms.students.edit')->withStudent($student)
                                    ->withCategories($categories)
                                    ->withCourses($courses)
                                    ->withStatuses($statuses)
                                    ->withCommunities($communities)
    ...
    public function editSubject($id){
        ...
        return view('sms.students.editSubject')->withSubjects($subjects)->withStudent($student);
    }
