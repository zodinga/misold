...
class InternalController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sms.internals.index')
                    ->withCourses($courses)
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('sms.internals.show',$internal->student_subject['student_id']);
    }
    ...
    public function show($id)
    {
        ...
        return view('sms.internals.show')->withStudent($student)
    ...
    public function edit($id)
    {
        ...
        if(isset($internal))
            return view('sms.internals.edit')->with('internal',$internal)->withSubject($subject);
        else{
            return view('sms.internals.create')->with('student_subject_id',$id)->withSubject($subject);
        }
    }
