...
class ResultController extends Controller
{
    ...
    public function store(Request $request)
    {
       $this->validate($request,array(
        ...
        return redirect()->route('sms.results.show',$result->student_subject['student_id']);
    }
    ...
    public function show($id)
    {
        ...
        return view('sms.results.show')->withStudent($student)
    ...
    public function edit($id)
    {
        ...
        if(isset($result))
        return view('sms.results.edit')->with('result',$result)->withSubject($subject);
        else
            return view('sms.results.create')->with('student_subject_id',$id)->withSubject($subject);
    }
