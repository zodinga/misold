...
class RegistrationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sms.registrations.index')->withCourses($courses)->withStudents($students);
    }
    ...
    public function search(Request $request)
    {
        ...
        $courses=Course::pluck('name','id');
        return view('sms.registrations.index')
                    ->withCourses($courses)
    ...
    public function create($id)
    {
        ...
        return view('sms.registrations.create')->withStudent($student);
    }
    ...
    public function edit($id)
    {
        ...
        return view('sms.registrations.edit')->withRegistration($registration)->withStudent_id($student_id);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('sms.registrations.create',$registration->student_id);
    }
