...
@section('content')
	<div class="row">
		...
		<div class="col-md-9">
			{!!Form::open(['route'=>'sms.internals.search','method'=>'get','class'=>'navbar-form navbar-left'])!!}
		...
		<div class="col-md-12">
			<table class="table">
				...
				<tr>
					...
					<td>
						<a href="{{route('sms.internals.show',$student->id)}}" class="btn btn-info btn-sm">Internal</a>
						<a href="{{route('sms.students.show',$student->id)}}" class="btn btn-primary btn-sm">View</a>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
	                            ...
	                            <div class="col-md-4 ">
	                      			<a href="{{route('sms.students.addAll',$student->id)}}" class="btn btn-danger">Automatic Add All Subjects</a>
						  		</div>
