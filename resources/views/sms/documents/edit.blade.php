...
<div class="row">
	<div class="col-md-6">
		{!! Form::model($document,['route'=>['sms.documents.update',$document->id],'method'=>'PUT','files'=>true]) !!}
		...
		<a href="/sms/documents/destroy/{{$document->id}}" class="btn btn-danger btn-block btn-h1-spacing">Delete</a>
	</div>
</div>
