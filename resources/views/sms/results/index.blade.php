...
@section('content')
	<div class="row">
		...
		<div class="col-md-8">
			{!!Form::open(['route'=>'sms.results.search','method'=>'get','class'=>'navbar-form navbar-left'])!!}
		...
		<div class="col-md-12">
			<table class="table">
				...
				<tr>
					...
					<td>
						<a href="{{route('sms.results.show',$student->id)}}" class="btn btn-info btn-sm">Result</a>
