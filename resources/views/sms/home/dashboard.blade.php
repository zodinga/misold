         ...
         <div class="clearfix">
              <div class="inner-content text-center">
                <div class="c100 p{{$percentage[0]}} big">
                    <span><a href="/sms/pages/students/1" title="Current MCA">mca</a></span>
                    <div class="slice">
                        <div class="bar"></div>
                        <div class="fill"></div>
                    </div>
                 ...
                 <div class="c100 p{{$percentage[1]}} big green">
                    <span><a href="/sms/pages/students/2" title="Current BCA">bca</a></span>
                    <div class="slice">
                        <div class="bar"></div>
                        <div class="fill"></div>
                    </div>
                ...
                <div class="c100 p{{$percentage[2]}} big orange">
                    <span><a href="/sms/pages/students/3" title="Current Diploma (DCSE/DETE)">diploma</a></span>
                    <div class="slice">
                        <div class="bar"></div>
                        <div class="fill"></div>
                    </div>
                ...
                <div class="c100 p{{$percentage[3]}} big yellow">
                    <span><a href="/sms/pages/students/4" title="Current Short Term Courses">short</a></span>
                    <div class="slice">
                        <div class="bar"></div>
                        <div class="fill"></div>
                    </div>
