...
@section('content')
<div class="row">
{!! Form::model($student,['route'=>['sms.students.update',$student->id,'data-parsley-validate'=>''],'method'=>'PUT','files'=>true]) !!}
	<div class="col-md-8">
	...
	<div class="col-md-4">
		<div class="well">
			...
			<div class="row">
				<div class="col-md-12">
				<a href="{{route('sms.students.editSubject',$student->id)}}" class="btn btn-info btn-block">Edit Subjects</a>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
				<a href="{{route('sms.documents.show',$student->id)}}" class="btn btn-primary btn-block btn-h1-spacing">Add Documents (Total: {{ $student->documents()->count() }})</a>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-sm-6">
					{!! Html::linkRoute('sms.students.show','Cancel',[$student],['class'=>'btn btn-danger btn-block']) !!}
				</div>
				<div class="col-sm-6">
			...
			<div class="row">
				<div class="col-md-12">
				{{Html::linkRoute('sms.students.index','<<All Students',[],['class'=>'btn btn-default btn-block btn-h1-spacing'])}}
				</div>
			</div>
		</div>
	</div>
