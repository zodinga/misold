...
@section('content')
	<div class="row">
		<div class="col-md-9">
			...
			<table class="table">
				...
				@foreach($subjects as $subject)
					<tr>
						<td>{{$subject->id}}</td>
						<td><a href="{{route('sms.subjects.edit',$subject->id)}}"> {{$subject->name}}</a></td>
		...
		<div class="col-md-3">
			<div class="well">
				{!!Form::open(['route'=>'sms.subjects.store','method'=>'POST','data-parsley-validate'=>''])!!}
					<h2>New Subject</h2>
					{{Form::label('name')}}
				...
				<!--Import new subjects-->
				{!! Form::open(['route' => 'sms.excel.importSubject','method'=>'post','data-parsley-validate'=>'','files'=>true]) !!}
				...
				<hr>
				<!--Export Subjects-->
				{!!Form::open(['route'=>'sms.excel.exportSubjects','method'=>'get'])!!}
