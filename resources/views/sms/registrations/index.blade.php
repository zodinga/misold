...
@section('content')
	<div class="row">
		...
		<div class="col-md-9">
			{!!Form::open(['route'=>'sms.registrations.search','method'=>'get','class'=>'navbar-form navbar-left'])!!}
		...
		<div class="col-md-12">
			<table class="table">
				...
				<tr>
					...
					<td>
						<a href="{{route('sms.registrations.create',$student->id)}}" class="btn btn-warning btn-sm">Register</a>
						<a href="{{route('sms.students.show',$student->id)}}" class="btn btn-info btn-sm">View</a>
					</td>
				</tr>
				@endforeach
				</tbody>
