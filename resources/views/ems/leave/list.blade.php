						  ...
						  <div class="panel-body">
							...
							<hr>
								<div class="row">
									...
									{!! Form::open(['route' => ['ems.leave.approve', $emp_leave->id],'data-parsley-validate'=>'']) !!}
										...
										<table class="table table-striped ">
											<tbody>
												...
												<tr>
													<th>No. of days applied for:</th><td>{{$emp_leave->no_of_days}}</td>
												</tr>
												<tr>
													<th>Dated</th><td> 
												...
												<tr>
													<th>Ground of leave</th><td>{{$emp_leave->ground}}</td>
												</tr>
...
<br>
									{!! Form::close() !!}
										...
										<div class="row">
												<div class="col-sm-6">
													{!! Html::linkRoute('ems.leave.pending','Pending',[$employees->id],['class'=>'btn btn-primary btn-block']) !!}
												</div>
												<div class="col-sm-6">
													<!-- Delete Modal -->
								                        ...
								                        <div class="modal-dialog">
								                          <div class="modal-content">
								                            ...
								                            <div class="modal-footer">
									                            ...
									                            <div class="col-md-7 ">
									                      			{!! Form::open(['route'=>['ems.leave.reject',$emp_leave->id],'data-parsley-validate'=>'']) !!}
								                      ...
								                      <a href="#Delete{{$employees->id}}"  role="button" class="btn btn-danger btn-block" data-toggle="modal" title="Delete Student">Reject</a>
								                      <!-- End Delete Modal -->
												</div>
											</div>
											<div class="row">
