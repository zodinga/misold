...
<tr>
	...
	<td><h3>{{$i=$i+1}}</h3></td><td><img src="{{$emp->photo?asset('photo/'.$empe->photo):'/img/user.jpg'}}" alt="..." class="img-rounded" height="33" width="28"></td><td><h3>{{ $emp->Fname}}</h3></td><td><a href="{{route('ems.leave.lists',$emp->id)}}" class="btn btn-info">View</a></td>
@endforeach
</tr>
</tbody>
</table>
...
@else
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="col-md-8">
				<h3>No request for leave right now. </h3>
